...
PythonHelp = f"⚡️ ​𝗜𝗡𝗦𝗔𝗡𝗘 𝗦𝗣𝗔𝗠 𝙃𝗘𝗟𝗣 𝙈𝗘𝗡𝗨 ⚡️\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @OgKaneki**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
                                  " https://graph.org/file/5294dc00f7c1b48b58ad6.png",
                                  caption=PythonHelp,
                                  buttons=[
           [
           ...
           [    
            Button.url("⚡️ ᴄʜᴀɴɴᴇʟ ⚡️", "https://t.me/INSANE_NETWORK"),
            Button.url("⚡️ sᴜᴘᴘᴏʀᴛ ⚡️", "https://t.me/insanesociety")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝐎𝐆 𝐊𝐀𝐍𝐄𝐊𝐈⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
